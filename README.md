...
| **[Troubleshooting](docs/troubleshooting.md)** | When something is not working: the startup banner, the missing microphone, the wake word, a screen that will not dim, and the way back in when you are locked out |
